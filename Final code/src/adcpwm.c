...
volatile uint8_t _duty0 = 0, _duty1 = 0, _duty2 = 0, _duty3 = 0, _duty4 = 0, _timer_tick;
...
void pwm5_set_duty(uint8_t input0, uint8_t input1, uint8_t input2, uint8_t input3, uint8_t input4)
{
    TCNT1 = 0;
    if (input0 <= 100)
    {
